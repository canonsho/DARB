...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = darbFirebaseUserStream()
...
class _NavBarPageState extends State<NavBarPage> {
  ...
  Widget build(BuildContext context) {
    final tabs = {
      ...
      'ChooseBudget': const ChooseBudgetWidget(),
      'map': const MapWidget(),
      ...
      bottomNavigationBar: GNav(
        ...
        tabs: const [
          GButton(
            ...
            iconSize: 43.0,
            backgroundColor: Color(0xFF988CB4),
          ),
          GButton(
          ...
          GButton(
            ...
            text: 'انطباعك',
            iconSize: 43.0,
            backgroundColor: Color(0xFFF3EDDB),
          )
        ],
      ),
    );
